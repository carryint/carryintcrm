...
// Also fix supabase.ts
let supabaseCode = fs.readFileSync('supabase.ts', 'utf8');
if(!supabaseCode.includes('/// <reference')) {
  fs.writeFileSync('supabase.ts', '/// <reference types="vite/client" />\\n' + supabaseCode);
}
